  ...
  group('TickEmitter', () {
    test('start-stop-start', () {
      FakeAsync(initialTime: DateTime(2000)).run((async) {
        ...
        expect(messages[0].cpuDuration, Duration.zero);
        ...
        expect(messages[1].cpuDuration, Duration.zero);
        ...
        expect(messages[2].cpuDuration, Duration.zero);
        ...
        expect(messages[3].cpuDuration, Duration.zero);
        ...
        expect(messages[4].cpuDuration, Duration.zero);
        ...
        expect(messages[5].cpuDuration, Duration.zero);
      });
    });
